...
class MainController extends Controller
{
    ...
    public function rating()
    {
         ...
         */
        $sMenDesc = t('You Men!') . '<br />' . t('Vote for the most beautiful women!');
        $sWomenDesc = t('You Women!') . '<br />' .t('Vote for the best men!');

        $this->view->page_title = t('Best - Tamil Kalyanam Site');
        $this->view->meta_description = $sMenDesc . ' ' . $sWomenDesc;
        $this->view->meta_keywords = t('best, rate, rating, voting ');
